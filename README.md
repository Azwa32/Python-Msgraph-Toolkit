...
"Built for real-world SharePoint and OneDrive workflows"
A modern, async-first API client for Microsoft Graph, built for SharePoint and Office 365 workflows.

Features, - Simple, business-focused API
- Async/await support
