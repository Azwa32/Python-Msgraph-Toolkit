...
# pytest tests/integration/test_sharepoint.py -W ignore::DeprecationWarning

# to run a single test from root folder (with print -s) eg: 
# pytest tests/integration/test_sharepoint.py::test_sites_get_sites -s -W ignore::DeprecationWarning
